        ...
        <div className="gutter-condensed">
            ...
            <div className="col-md-left mb-md-0">
                <div className="pl-4">
                    ...
                    Created <strong className="d-inline-block">{props.created_to_now} years ago</strong></div>
            </div>
            <div className="col-md-left">
                <div className="pl-4">
                    ...
                    <strong>More than 1K</strong> <span className="d-inline-block">GitHub users</span></div>
            </div>
        </div>
    </div>
